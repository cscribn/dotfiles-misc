...
#
# USAGE: Import-Module Terminal-Icons must run first.
...
$emojiMap = @{
    ...
    'nf-md-folder_download'         = '📥'  # downloads
    ...
    'nf-seti-config'                = '⚙️'  # .config
    'nf-md-cached'                  = '🧹'  # .cache
    'nf-custom-folder_config'       = '🆚'  # .vscode / .vscode-insiders
    ...
    'nf-seti-json'                  = '🗂️'  # tsconfig/tslint/composer.lock/etc.
    'nf-md-xml'                     = '📰'  # .htaccess & xml-ish files
    ...
    # ---- Extensions ----
    'nf-oct-file_zip'               = '📦'  # archives (.zip/.tar/.rar/...)
    'nf-custom-msdos'               = '🦇'  # .bat / .cmd
    'nf-md-application'             = '🚀'  # .exe
    'nf-dev-perl'                   = '🐪'  # .pl
    ...
    'nf-dev-rust'                   = '🦀'  # .rs
    'nf-dev-database'               = '🗃️' # .sql/.mdb/.sqlite/...
    'nf-seti-db'                    = '🗃️' # .db
    ...
    'nf-md-file_powerpoint'         = '📽️' # .pptx/.ppt/...
    ...
    'nf-dev-less'                   = '🎨'  # .less
    'nf-dev-markdown'               = '📝'  # .md/.markdown/.rst
    'nf-seti-mustache'              = '🌐'  # .hbs
    'nf-md-format_align_left'       = '🗂️' # .yml/.yaml
    'nf-seti-lua'                   = '🌙'  # .lua
    ...
    'nf-dev-sublime'                = '🆂'  # .sublime-project/.sublime-workspace
}
